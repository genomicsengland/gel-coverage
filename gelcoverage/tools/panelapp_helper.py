...
class PanelappHelper:
    ...
    def get_gene_list(self, panel, panel_version, gene_confidence_threshold=3):
        ...
        :param str panel: the panel name
        :param str panel_version: the panel version
        :param int gene_confidence_threshold: the gene's level of evidence
        ...
        # force an integer comparison here
