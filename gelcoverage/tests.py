...
FILTER_BIOTYPES = (
    "IG_C_gene,IG_D_gene,IG_J_gene,IG_V_gene,IG_V_gene,protein_coding,nonsense_mediated_decay,"
...
class GelCoverageRunnerTests(OutputVerifier):
    ...
    def test1(self):
        ...
        runner = GelCoverageRunner(config=self.config)
    ...
    def test5(self):
        ...
        union_transcript = runner._GelCoverageRunner__create_union_transcript(
            gene_15bp_padding
        )
    ...
    def test6_1(self):
        ...
        self.assertTrue(
            caught_exception,
            msg="It should have raised an exception as bed and bigwig are using"
    ...
    def test9(self):
        ...
        self.assertEqual(
            output["results"]["uncovered_genes"][0][constants.GENE_NAME], "PTEN"
        )
